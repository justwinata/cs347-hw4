...
DROP TABLE SIM_project_rel CASCADE CONSTRAINTS ;
...
CREATE TABLE SIM_project_rel
  (
    dept_id                INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER ,
    SIM_project_project_id INTEGER
  ) ;
ALTER TABLE SIM_project_rel ADD CONSTRAINT SIM_project_rel_PK PRIMARY KEY ( dept_id ) ;
...
ALTER TABLE SIM_project_rel ADD CONSTRAINT SIM_project_rel_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_project_rel ADD CONSTRAINT SIM_project_rel_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
